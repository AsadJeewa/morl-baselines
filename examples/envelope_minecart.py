...
def main(total_timesteps: int = 500000, exp_type: str = None, wandb_mode: str = "online", log: bool = True, seed: int = 0, use_argmax_for_envelope: bool = False, use_train_weights_for_envelope: bool = False, exp_notes: str = "", mine_config: str = "mine_config.json"):
